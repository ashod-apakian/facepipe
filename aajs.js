...
*/
 ...
 for(j=0;j<count;j++)
  ...
  if(c==1)
   ...
   {
   sx0=xyuv0[i].x; sx1=xyuv1[i].x; sx2=xyuv2[i].x; sx3=xyuv3[i].x;
   sy0=xyuv0[i].y; sy1=xyuv1[i].y; sy2=xyuv2[i].y; sy3=xyuv3[i].y;
   su0=xyuv0[i].u; su1=xyuv1[i].u; su2=xyuv2[i].u; su3=xyuv3[i].u;
   sv0=xyuv0[i].v; sv1=xyuv1[i].v; sv2=xyuv2[i].v; sv3=xyuv3[i].v;
   }
  grp.ctx.save();
  grp.ctx.strokeStyle="none";
  grp.ctx.fillStyle="none";
  grp.ctx.lineWidth=0;
  for(t=0;t<c;t++)
   {
...
//  console.log(obj.avc);
 ...
 if(dhandle!=null)
  ...
  ///console.log(arguments.callee.name,"attached");
  }
 else
  {
  ///aa.debugAlert();
...
//  dobj.dom.volume=0;
  ...
  //console.log(arguments.callee.name,"dettached");
  }
 return true;
 }
 ...
 switch(obj.stage)
  ...
  //console.log(arguments.callee.name,"stage 100, creating");
  //console.log(obj.avc);
  ...
  //console.log(arguments.callee.name,"stage 150, creating");
  //console.log(obj.avc);

  //obj.prom=navigator.mediaDevices.getUserMedia(obj.avc)
  //obj.avc.surfaceSwitching="include";
  //console.log(obj.avc);
...
//console.log("ee");
  //console.log(obj.v_stream);
  //console.log(obj.v_contraints);
  //console.log(obj.a_stream);
  //console.log(obj.a_contraints);
...
//-----------------------------------------------------------------------
 ...
 var grp;
 if((grp=aa.guiGroupGet(handle))==null) { return false; }
 //console.log("videoMuteSet ",state);
 ///aa.debugAlert();
 ...
 main_obj.state.thread_id=window.setTimeout(function()
  ...
  mainProc();
   ...
   if(1&&(aa.iface_obj.is_started==true&&aa.iface_obj.blit_hz<60))
    {
    if((window.document.hasFocus()==false||document.hidden==true))
     {
     aa.ifaceBlit(-1);
     }
    }
   ...
   if(perc>=minperc&&perc<=maxperc)
    ...
    if((speed>=minhz&&speed<=maxhz))///&&(maxnum>num))
     ...
     if(dostyle==0)
      ...
      if(dopathed==0) { str=""+obj.name+"";    txt+=str.padEnd(48-8); }
      else            { str=""+obj.name+"";    txt+=str.padEnd(54-8); }
